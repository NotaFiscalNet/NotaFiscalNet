...
namespace NotaFiscalNet.Core
{
    ...
    public enum SituacaoTributariaCOFINS
    {
        ...
        NaoEspecificado = -1,
        /// <summary>
        /// 01 - Operação Tributável - Base de Cálculo igual ao Valor da Operação com Alíquota Normal (Cumulativo / Não Cumulativo).
        /// </summary>
        Cst01 = 1,
        /// <summary>
        ...
        Cst02 = 2,
        /// <summary>
        /// 03 - Operação Tributável - Base de Cálculo igual a Quantidade Vendida x Alíquota por Unidade de Produto.
        /// </summary>
        Cst03 = 3,
        /// <summary>
